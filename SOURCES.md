...
What has been searched, when, and how. If a venue isn't here, it hasn't been covered; open an issue or a PR.

| venue | method | date swept | notes |
|---|---|---|---|
| PauseAI p(doom) list | seed; every entry re-verified against its primary | 2026-09-12 | Hoffman dropped (not a probability); LeCun and Lifland corrected |
| Doom Debates (Liron Shapira), all ~204 Substack posts | crawler + hand review of 577 passages | 2026-09-12 | `tools/crawl_doom_debates.py` in the site repo |
| Frontier lab leaders and senior researchers | targeted search per name | 2026-09-12 | includes the Sept 2026 cascade of lab-staff statements |
...
| e/acc and accelerationists; politicians and officials; hearings | targeted search | 2026-09-13 | in progress |
| Public opinion polls (YouGov, Ipsos, Monmouth, AIPI, Rethink Priorities); Lex Fridman full pass; Bankless 2023 | targeted search | 2026-09-13 | in progress |

## Not yet covered

For Humanity (John Sherman), AXRP, Clearer Thinking, FLI Podcast, Machine Learning Street Talk, Win-Win, Sam Harris, Ezra Klein full pass, Conversations with Tyler, non-English sources (Chinese, Japanese, European researchers), YouTube-only statements (captions are IP-blocked from the maintainer's environment), X search (blocked; contributions welcome).
